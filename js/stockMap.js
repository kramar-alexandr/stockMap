...
function getStockMovData(smNum){ //Download warehouse structure data
  ...
  if(window.location.protocol!=='file:'){//for real data remote request
    ...
    data = {"items":[{"item":"1004321","name":"","ordquant":"7,00","sentquant":"","fromplace":"A1-07","toplace":"A2-12"},{"item":"1000760","name":"","ordquant":"4,00","sentquant":"","fromplace":"A1-01","toplace":"A1-04"},{"item":"2510005","name":"","ordquant":"7,00","sentquant":"","fromplace":"A1-07","toplace":"A2-12"}]}
    colorElements(data);
  }
